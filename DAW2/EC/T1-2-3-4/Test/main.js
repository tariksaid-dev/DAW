...
console.log(eliminarElemento([1, 2, 3, 4, 2], 2));
...
console.log(buscarElemento([1, 2, 3, 4, 4], 4));
...
function dividirFragmento(arr, num) {
  ...
  for (let i = 0; i < arr.length; i += num) {
    res.push(arr.slice(i, num + i));
  }

  return res;
}

console.log(dividirFragmento([1, 2, 3, 4, 5, 6], 3));
...
console.log(rotarArray([1, 2, 3, 4, 5, 6, 7, 8, 9], 1));
