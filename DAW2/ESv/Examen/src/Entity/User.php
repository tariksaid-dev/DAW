...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
  ...
  public function addEquipo(Pokemon $equipo): static
  {

    if ($this->equipo->count() >= 6) {
      throw new \RuntimeException("No se pueden añadir más pokemons");
    }
  ...
  public function removeEquipo(Pokemon $equipo): static
  {
